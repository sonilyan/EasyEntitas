...
namespace Entitas.VisualDebugging.Unity.Editor {
    ...
    public static partial class EntityDrawer {
        ...
        public static void DrawComponent(bool[] unfoldedComponents, string[] componentMemberSearch, IContext context, IEntity entity, int index, IComponentBase component) {
        ...
        public static bool DrawObjectMember(Type memberType, string memberName, object value, object target, Action<object, object> setValue) {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                if (typeDrawer != null) {
                    ...
                    var shouldDraw = !targetType.ImplementsInterface<IComponentBase>() || !Attribute.IsDefined(targetType, typeof(DontDrawComponentAttribute));
                    if (shouldDraw) {
