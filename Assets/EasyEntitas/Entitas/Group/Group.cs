...
namespace Entitas {
    ...
    public class Group : IGroup {
	    ...
	    public event GroupBeforeUpdated OnEntityBeforeUpdated;
        ...
        /// This is used by the context to manage the group.
        public void HandleEntity(Entity entity, int index, IComponentBase component) {
            if (_matcher.Matches(entity)) {
		...
		public void BeforeUpdateEntity(Entity entity, int index, IComponentBase component) {
			if (_entities.Contains(entity)) {
				if (OnEntityBeforeUpdated != null) {
					OnEntityBeforeUpdated(this, entity, index, component);
				}
			}
		}

		/// This is used by the context to manage the group.
		public void UpdateEntity(Entity entity, int index, IComponentBase previousComponent, IComponentBase newComponent) {
	        if (_entities.Contains(entity)) {
        ...
        void addEntity(Entity entity, int index, IComponentBase component) {
        ...
        void removeEntity(Entity entity, int index, IComponentBase component) {
            var removed = _entities.Remove(entity);
            if (removed) {
                _entitiesCache = null;
                _singleEntityCache = null;
