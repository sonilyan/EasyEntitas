...
namespace Entitas {
    ...
    public class Systems : IInitializeSystem, IExecuteSystem, ICleanupSystem, ITearDownSystem {
	    ...
	    protected Systems systems_wapper;
		public Systems(Systems systems) {
			this.systems_wapper = systems;
			_initializeSystems = systems._initializeSystems;
			_executeSystems = systems._executeSystems;
			_cleanupSystems = systems._cleanupSystems;
			_tearDownSystems = systems._tearDownSystems;
		}
