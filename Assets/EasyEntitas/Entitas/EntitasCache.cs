...
namespace Entitas {
    ...
    public static class EntitasCache {
        ...
        public static List<IComponentBase> GetIComponentList() { return _cache.Get<List<IComponentBase>>(); }
        public static void PushIComponentList(List<IComponentBase> list) { list.Clear(); _cache.Push(list); }
